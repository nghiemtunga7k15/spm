        ...
        <div class="jeg_content">
            ...
            <div class="row" style="padding: 50px">
                <div class="jeg_author_image">
                    <img alt='tacgia' src='{{ asset('upload/users/'.$user->image)}}' srcset='{{ asset('upload/users/'.$user->image)}}' class='avatar avatar-110 photo' height='110' width='110' />
                </div>
                <div class="jeg_author_content">
                    <h3 class="jeg_author_name fn">{{$user->name}}</h3>
                    <div class="jeg_author_desc">{{$user->email}}</div>
	            </div>
            </div>
                ...
                <div class="jeg_thumb">
                  <a href="{{route('online.blog.news', $postt->id)}}"><div class="thumbnail-container animate-lazy  size-715 "><img width="350" height="250" src="{{ asset('upload/posts/'.$postt->image)}}" class="attachment-jnews-350x250 size-jnews-350x250 lazyload wp-post-image" alt="Social" data-src="{{ asset('upload/posts/'.$postt->image)}}" data-sizes="auto" data-srcset="" data-expand="700" /></div></a>
                    <div class="jeg_post_category">
                        <span><a href="{{route('online.blog.menu', $postt->categories_post->id)}}" class="category-cong-cu-marketing">{{$postt->categories_post->name}}</a></span>
                    </div>
                </div>
                <div class="jeg_postblock_content">
                    ...
                    <div class="jeg_post_meta"><div class="jeg_meta_author"><span class="by">Bởi</span> <a href="">{{$postt->users_id->name}}</a></div><div class="jeg_meta_date"><a href=""><i class="fa fa-clock-o"></i> {{$postt->post_time}}</a></div><div class="jeg_meta_comment"><a href="" ><i class="fa fa-comment-o"></i> {{$postt->comment_count}} </a></div></div>
